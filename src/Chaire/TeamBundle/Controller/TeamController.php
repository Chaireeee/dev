...
use Chaire\TeamBundle\Entity\Team;
use Chaire\TeamBundle\Form\TeamType;
use Chaire\TeamBundle\Form\TeamEditType;
...
class TeamController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ChaireTeamBundle:Team')->findAll();
     ...
     * @Method("POST")
     * @Template("ChaireTeamBundle:Team:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ChaireTeamBundle:Team')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new TeamEditType(), $entity, array(
     ...
     * @Method("PUT")
     * @Template("ChaireTeamBundle:Team:edit.html.twig")
     */
