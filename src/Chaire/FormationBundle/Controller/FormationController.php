...
class FormationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ChaireFormationBundle:Formation')->findAll();
     ...
     * @Method("POST")
     * @Template("ChaireFormationBundle:Formation:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ChaireFormationBundle:Formation:edit.html.twig")
     */
