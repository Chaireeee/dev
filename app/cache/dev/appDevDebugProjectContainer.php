...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'chaire.mailjet' => 'getChaire_MailjetService',
            ...
            'knp_mailjet.api' => 'getKnpMailjet_ApiService',
            'knp_mailjet.event.controller' => 'getKnpMailjet_Event_ControllerService',
            'knp_mailjet.event.factory' => 'getKnpMailjet_Event_FactoryService',
    ...
    /**
     * Gets the 'chaire.mailjet' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Chaire\AccueilBundle\Services\MailjetService A Chaire\AccueilBundle\Services\MailjetService instance.
     */
    protected function getChaire_MailjetService()
    {
        return $this->services['chaire.mailjet'] = new \Chaire\AccueilBundle\Services\MailjetService();
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8e23acb8f0c9f743624fbc301bc289ea6d064de18efe18d780847364ac582b92');
    ...
    protected function getIvoryCkEditor_ConfigManagerService()
    {
        ...
        $instance->setConfig('my_config', array('toolbar' => array(0 => array(0 => 'Source', 1 => '-', 2 => 'Save', 3 => 'Preview'), 1 => array(0 => 'Bold', 1 => 'Italic', 2 => 'Underline', 3 => 'Strike', 4 => 'Subscript', 5 => 'Superscript', 6 => '-', 7 => 'RemoveFormat'), 2 => array(0 => 'NumberedList', 1 => 'BulletedList')), 'uiColor' => '#ffffff'));
    ...
    /**
     * Gets the 'knp_mailjet.api' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Mailjet\Api\Client A Mailjet\Api\Client instance.
     */
    protected function getKnpMailjet_ApiService()
    {
        return $this->services['knp_mailjet.api'] = new \Mailjet\Api\Client('47039397992f5b138b2ba0cf1a0d96b7', '4f1f6f3593c6540129ff5ad18d531116');
    }

    /**
     * Gets the 'knp_mailjet.event.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Bundle\MailjetBundle\Controller\EventController A Knp\Bundle\MailjetBundle\Controller\EventController instance.
     */
    protected function getKnpMailjet_Event_ControllerService()
    {
        return $this->services['knp_mailjet.event.controller'] = new \Knp\Bundle\MailjetBundle\Controller\EventController($this->get('knp_mailjet.event.factory'), $this->get('debug.event_dispatcher'), NULL);
    }

    /**
     * Gets the 'knp_mailjet.event.factory' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Knp\Bundle\MailjetBundle\Event\EventFactory A Knp\Bundle\MailjetBundle\Event\EventFactory instance.
     */
    protected function getKnpMailjet_Event_FactoryService()
    {
        return $this->services['knp_mailjet.event.factory'] = new \Knp\Bundle\MailjetBundle\Event\EventFactory();
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Chaire/AccueilBundle/Resources/translations/messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Chaire/AccueilBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Chaire/EventBundle/Resources/translations/messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Chaire/EventBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Chaire/AdminBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Chaire/FormationBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Chaire/TeamBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/GenerateurBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Chaire/AccueilBundle/Resources/views'), 'ChaireAccueil');
        $instance->addPath(($this->targetDirs[3].'/src/Chaire/EventBundle/Resources/views'), 'ChaireEvent');
        $instance->addPath(($this->targetDirs[3].'/src/Chaire/AdminBundle/Resources/views'), 'ChaireAdmin');
        $instance->addPath(($this->targetDirs[3].'/src/Chaire/FormationBundle/Resources/views'), 'ChaireFormation');
        $instance->addPath(($this->targetDirs[3].'/src/Chaire/TeamBundle/Resources/views'), 'ChaireTeam');
        $instance->addPath(($this->targetDirs[3].'/src/GenerateurBundle/Resources/views'), 'Generateur');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2ca110738b43f948489a0b2ee4b43f671');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ChaireAccueilBundle' => 'Chaire\\AccueilBundle\\ChaireAccueilBundle',
                'ChaireEventBundle' => 'Chaire\\EventBundle\\ChaireEventBundle',
                'ChaireAdminBundle' => 'Chaire\\AdminBundle\\ChaireAdminBundle',
                'ChaireFormationBundle' => 'Chaire\\FormationBundle\\ChaireFormationBundle',
                'ChaireTeamBundle' => 'Chaire\\TeamBundle\\ChaireTeamBundle',
                'KnpMailjetBundle' => 'Knp\\Bundle\\MailjetBundle\\KnpMailjetBundle',
                'GenerateurBundle' => 'GenerateurBundle\\GenerateurBundle',
            ...
            'locale' => 'fr',
            'secret' => '2ca110738b43f948489a0b2ee4b43f671',
            ...
            'kernel.secret' => '2ca110738b43f948489a0b2ee4b43f671',
            ...
            'knp_mailjet.event.endpoint_route' => 'knp_mailjet_event_endpoint',
            'knp_mailjet.event.endpoint_token' => NULL,
            ...
            'knp_mailjet.api_key' => '47039397992f5b138b2ba0cf1a0d96b7',
            'knp_mailjet.secret_key' => '4f1f6f3593c6540129ff5ad18d531116',
            'knp_mailjet.api.class' => 'Mailjet\\Api\\Client',
