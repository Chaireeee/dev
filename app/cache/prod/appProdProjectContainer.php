...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_61d95a7a66a158d1afcb731d7d344564a97112d18662999c531f79de1f993eee');
        return $instance;
    }
    ...
    {
        return $this->services['knp_mailjet.event.controller'] = new \Knp\Bundle\MailjetBundle\Controller\EventController($this->get('knp_mailjet.event.factory'), $this->get('event_dispatcher'), NULL);
    }
    ...
    protected function getTemplating_Helper_FormService()
    {
        ...
        $a->setCharset('UTF-8');
        $a->setHelpers(array('slots' => 'templating.helper.slots', 'assets' => 'templating.helper.assets', 'request' => 'templating.helper.request', 'session' => 'templating.helper.session', 'router' => 'templating.helper.router', 'actions' => 'templating.helper.actions', 'code' => 'templating.helper.code', 'translator' => 'templating.helper.translator', 'form' => 'templating.helper.form', 'stopwatch' => 'templating.helper.stopwatch', 'logout_url' => 'templating.helper.logout_url', 'security' => 'templating.helper.security', 'assetic' => 'assetic.helper.static', 'ivory_ckeditor' => 'ivory_ck_editor.templating.helper'));
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Chaire/AdminBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/GenerateurBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        return $instance;
    }
