 ...
 */
class Slide extends \GenerateurBundle\Entity\Slide implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'GenerateurBundle\\Entity\\Slide' . "\0" . 'name', '' . "\0" . 'GenerateurBundle\\Entity\\Slide' . "\0" . 'page', 'ordre', '' . "\0" . 'GenerateurBundle\\Entity\\Slide' . "\0" . 'fond');
        }
