 ...
 */
class Stype8 extends \GenerateurBundle\Entity\Stype8 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GenerateurBundle\\Entity\\Stype8' . "\0" . 'texte1', '' . "\0" . 'GenerateurBundle\\Entity\\Stype8' . "\0" . 'url', 'id', 'ordre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Stype8 $proxy) {
