 ...
 */
class Stype3 extends \GenerateurBundle\Entity\Stype3 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GenerateurBundle\\Entity\\Stype3' . "\0" . 'texte1', '' . "\0" . 'GenerateurBundle\\Entity\\Stype3' . "\0" . 'texte2', 'id', 'ordre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Stype3 $proxy) {
