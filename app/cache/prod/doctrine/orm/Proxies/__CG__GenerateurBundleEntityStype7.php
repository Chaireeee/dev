 ...
 */
class Stype7 extends \GenerateurBundle\Entity\Stype7 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GenerateurBundle\\Entity\\Stype7' . "\0" . 'event', 'id', 'ordre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Stype7 $proxy) {
