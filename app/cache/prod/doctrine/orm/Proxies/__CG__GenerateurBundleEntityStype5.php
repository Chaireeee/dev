 ...
 */
class Stype5 extends \GenerateurBundle\Entity\Stype5 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GenerateurBundle\\Entity\\Stype5' . "\0" . 'texte1', '' . "\0" . 'GenerateurBundle\\Entity\\Stype5' . "\0" . 'texte2', '' . "\0" . 'GenerateurBundle\\Entity\\Stype5' . "\0" . 'photo1', '' . "\0" . 'GenerateurBundle\\Entity\\Stype5' . "\0" . 'photo2', 'id', 'ordre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Stype5 $proxy) {
