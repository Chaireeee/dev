 ...
 */
class Stype1 extends \GenerateurBundle\Entity\Stype1 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GenerateurBundle\\Entity\\Stype1' . "\0" . 'texte', '' . "\0" . 'GenerateurBundle\\Entity\\Stype1' . "\0" . 'photo', 'id', 'ordre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Stype1 $proxy) {
