 ...
 */
class Stype4 extends \GenerateurBundle\Entity\Stype4 implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'GenerateurBundle\\Entity\\Stype4' . "\0" . 'texte1', '' . "\0" . 'GenerateurBundle\\Entity\\Stype4' . "\0" . 'texte2', '' . "\0" . 'GenerateurBundle\\Entity\\Stype4' . "\0" . 'texte3', 'id', 'ordre');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Stype4 $proxy) {
